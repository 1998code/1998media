...
export const StaggeredMenu = ({
  ...
  const Overlay = (
    ...
    >
      ...
      <aside
        ref={panelRef}
        className="staggered-menu-panel fixed top-0 right-0 h-full bg-white/90 backdrop-blur-xl flex flex-col p-[3em_2em_2em_2em] overflow-y-auto z-[9999] pointer-events-auto"
