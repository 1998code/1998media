export default function Skills() {
  const certs = [
    { name: '用戶體驗 (UX) 設計', icons: 'fa-google', href: 'https://coursera.org/verify/KDTDPH6RCXZD', bgColor: 'bg-blue-500' }
  ]
  const softwares = [
  ...
  return (
    <div id="skills" data-aos="zoom-in" data-aos-once className="relative pt-16 md:py-20 px-4 sm:px-6 lg:px-8">
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="mt-10">
          <h2 className="text-gray-500 text-xs font-medium uppercase tracking-wide">認證</h2>
