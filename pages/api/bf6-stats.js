export default async function handler(req, res) {
  ...
  const { locale = 'en', user = 'chakmingea', week = 'OpenBetaWeekend2' } = req.query;
  ...
  try {
    const response = await fetch(`https://drop-api.ea.com/player/${user}/stats?gameSlug=battlefield-6&eventName=${week}&locale=${apiLocale}`, {
      headers: {
