...
export default async function handler(req) {
    ...
    try {
        ...
        response.headers.append('Set-Cookie', `spotify_personal_token=${data.access_token}; Path=/; HttpOnly; SameSite=Lax; Max-Age=3600`);
        response.headers.append('Set-Cookie', `spotify_personal_refresh=${data.refresh_token}; Path=/; HttpOnly; SameSite=Lax; Max-Age=2592000`);
