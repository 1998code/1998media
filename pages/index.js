    ...
    <div>
      ...
      <body onload="choosePic()">
        ...
        <nav class="navbar navbar-light navbar-expand-lg sticky-top navigation-clean">
            <div class="container">
                <a class="navbar-brand" id="branding" href="#">1998 MEDIA</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navcol">
                    <ul class="navbar-nav ms-auto" id="nav">
                        <li class="nav-item dropdown" id="navItem"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">Showcase&nbsp;</a>
                            <div class="dropdown-menu" id="menuDropDown"><a class="dropdown-item" href="https://photoblog.1998.media" target="_blank"><i class="fas fa-camera"></i>&nbsp;Photoblog</a><a class="dropdown-item" href="https://portfolio.1998.media" target="_blank"><i class="fas fa-grip-horizontal"></i>&nbsp;Design Portfolio</a><a class="dropdown-item" href="https://www.behance.net/1998design" target="_blank"><i class="fab fa-behance"></i>&nbsp;Behance</a><a class="dropdown-item" href="https://dribbble.com/1998design" target="_blank"><i class="fab fa-dribbble"></i>&nbsp;Dribbble</a></div>
                        </li>
                        ...
                        <div class="dropdown-menu" id="menuDropDown" dangerouslySetInnerHTML={{ __html: translator }}></div>
                        </li>
                    </ul>
                </div>
            </div>
