...
export default function Home() {
  ...
  const about = '<div class="container" id="aboutContainer"> <h1><strong>About</strong></h1> <div class="row"> <div class="col-md-12 col-lg-12 col-xl-4 col-xxl-4 d-flex d-sm-flex d-md-flex d-xxl-flex flex-column justify-content-center justify-content-sm-center justify-content-md-center align-items-md-start justify-content-xxl-center align-items-xxl-start" data-aos="fade-up" data-aos-once="true" id="who"> <div id="whoDiv"> <h2 id="whoHeading">Who am I</h2> <p id="whoParagraph">An outgoing &amp; motivated person with unlimited creativity, studying within a great IT environment. Eager to work in a large and professional MNC in Design and Programming related industry in the future.</p> </div> </div> <div class="col-md-6 col-lg-6 col-xl-4 col-xxl-4 d-flex d-sm-flex d-md-flex d-xxl-flex flex-column justify-content-center justify-content-sm-center justify-content-md-center align-items-md-start justify-content-xxl-center align-items-xxl-start" data-aos="fade-up" data-aos-once="true" id="edu"> <div class="d-xxl-flex flex-column" id="eduDiv"> <h2 id="eduHeading">Bachelor degree</h2> <p class="flex-grow-1" id="eduParagraph">A science student graduated at The Hong Kong Polytechnic University and City University of Hong Kong.<br />Passed Korean TOPIK language exam in 2018.</p><a class="text-truncate" id="cityuCert" href="https://www.cityu.edu.hk/e-certification/nvkrwyua" target="_blank"><i class="fas fa-user-check"></i>&nbsp;CityU e-Cert Verification&nbsp;<i class="fas fa-external-link-alt"></i></a> </div> </div> <div class="col-md-6 col-lg-6 col-xl-4 col-xxl-4 d-flex d-sm-flex d-md-flex d-xxl-flex flex-column justify-content-center justify-content-sm-center justify-content-md-center align-items-md-start justify-content-xxl-center align-items-xxl-start" data-aos="fade-up" data-aos-once="true" id="do"> <div id="doDiv"> <h2 id="doHeading">What I Do</h2> <p id="doParagraph">UI &amp; UX Design<br />iOS&nbsp;&amp; iPadOS&nbsp;&amp; macOS&nbsp;&amp; Web Application Development<br />2D&nbsp;&amp; 3D Product Mockup<br />Deep Machine Learning<br />Photography<br />Short Video Production</p> </div> </div> </div> <div class="row"> <div class="col-xl-5 col-xxl-5" data-aos="fade-up" data-aos-once="true" id="exp"> <h2 id="expHeading"><strong>Experience</strong></h2> <div class="accordion" role="tablist" id="accordion-exp"> <div class="accordion-item" id="2022" style="border-width: 0px;border-radius: 15px 15px 0px 0px;"> <h2 class="accordion-header" role="tab"><button class="accordion-button" data-bs-toggle="collapse" data-bs-target="#accordion-exp .item-1" aria-expanded="true" aria-controls="accordion-exp .item-1" style="border-top-left-radius: 15px;border-top-right-radius: 15px;">2022</button></h2> <div class="accordion-collapse collapse show item-1" role="tabpanel" data-bs-parent="#accordion-exp"> <div class="accordion-body"> <p class="mb-0">Swivel Software Limited<br />‣ Software Engineer <br />‣‣ User Interface Design and Web System Development<br /><br /></p> <p class="mb-0">Start photo &amp; 3D artworks on Unsplash platforms<br /><br /></p> <p class="mb-0">Articles Writer on Medium<br /><br /></p> <p class="mb-0">Apple App Developer (iOS, watchOS, iPadOS, macOS)<br /></p> </div> </div> </div> <div class="accordion-item" id="2021" style="border-width: 0px;"> <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-exp .item-2" aria-expanded="false" aria-controls="accordion-exp .item-2">2020 - 2021</button></h2> <div class="accordion-collapse collapse item-2" role="tabpanel" data-bs-parent="#accordion-exp"> <div class="accordion-body"> <p class="mb-0">Swivel Software Limited<br />‣ Software Engineer ‣ User Interface Design and Web System Development<br /><br />Alpha Fund Solutions&nbsp;Limited<br />‣&nbsp;I.T. Support Staff&nbsp;‣ Survey &amp; Data Processing System Development<br /><br />Articles Writer on Medium<br /><br />Apple App Developer (iOS, watchOS, iPadOS, macOS)<br /><br />The Hong Kong Polytechnic University<br />‣ Student Assistant (PT)&nbsp;‣ Data analytics and visualisation<br />‣ Student Developer&nbsp;‣ Participate in Artificial Intelligence (A.I.) and Natural Language Processing (N.L.P) research field<br />‣ Student Assistant (PT)&nbsp;‣ Develop website &amp; design booklet for College Language Scolar Program<br /></p> <p class="mb-0"><br />Volunteer Works:<br /><span style="color: var(--bs-blue);">- Atlassian, Australia -- As a Translator (Chinese, Korean) language of the BitBucket.org Team</span><br /><span style="color: var(--bs-teal);">- Tokyo Metropolitan Government, Japan -- As a CHT Translator of the StopCovid19Tokyo Team with Code of Japan</span><br /></p> </div> </div> </div> <div class="accordion-item" id="2019" style="border-width: 0px;border-bottom-left-radius: 15px;border-bottom-right-radius: 15px;"> <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-exp .item-3" aria-expanded="false" aria-controls="accordion-exp .item-3" style="border-bottom-left-radius: 15px;border-bottom-right-radius: 15px;">2019</button></h2> <div class="accordion-collapse collapse item-3" role="tabpanel" data-bs-parent="#accordion-exp"> <div class="accordion-body"> <p class="mb-0">Start Freelance works on different platforms (Adobe Stock, Behance, Dribbble)<br /></p> </div> </div> </div> </div> <h2 id="awardsHeading">Awards</h2><img class="img-fluid" id="wwdc21Winner" src="assets/img/WWDC21Winner.png?h=635e76ae457bd315d787163181b80dd7"> </div> <div class="col-xl-7 col-xxl-7" data-aos="fade-up" data-aos-once="true" id="skillsLang"> <h2 id="skillsLangHeading">Skills &amp; Languages</h2> <div id="skills"> <div class="table-responsive"> <table class="table"> <thead> <tr> <th>Softwares*</th> </tr> </thead> <tbody> <tr> <td>Adobe Creative Cloud</td> <td>Apple Xcode</td> <td>Microsoft Office</td> </tr> <tr> <td>Adobe XD</td> <td>Apple Keynote</td> <td>Google Worksuite</td> </tr> <tr> <td>Adobe Dimension</td> <td>Apple Pages</td> <td>PowerBI</td> </tr> <tr> <td>Adobe Photoshop</td> <td>Final Cut Pro</td> <td>Motion</td> </tr> <tr> <td>Adobe Premiere Pro</td> <td>Figma</td> <td>Sketch</td> </tr> <tr> <td>Adobe Lightroom</td> <td>Framer</td> <td>Microsoft SQL Server</td> </tr> <tr> <td>Adobe Dreamweaver</td> <td>Unity Engine</td> <td>MySQLWorkbench</td> </tr> <tr> <td>C4D</td> <td>Shapr3D</td> <td>Table Plus</td> </tr> </tbody> </table> </div> <div class="table-responsive"> <table class="table"> <thead> <tr> <th>Programming Languages*</th> </tr> </thead> <tbody> <tr> <td>JS</td> <td>Vue</td> <td>VuetifyJS</td> <td>NuxtJS</td> </tr> <tr> <td>CSS</td> <td>Bootstrap 5</td> <td>TailwindCSS</td> <td></td> </tr> <tr> <td>Swift</td> <td>SwiftUI</td> <td>CoreData</td> <td>CloudKit</td> </tr> </tbody> </table> </div> <p id="skillsRemark">*Random sort - does not mean the order of proficient level</p> <div class="table-responsive"> <table class="table"> <thead> <tr> <th>Proficient in both spoken and written&nbsp;</th> <th>Proficient in spoken</th> <th>Basic in</th> </tr> </thead> <tbody> <tr> <td>Cantonese (Chinese Traditional)</td> <td>Korean (Passed the Test of Proficiency in Korean in 2018)</td> <td>Japanese</td> </tr> <tr> <td>English (the United Kingdom, United States of America)</td> <td>Mandarin&nbsp;(Chinese Simplified)</td> <td></td> </tr> </tbody> </table> </div> </div> </div> </div> </div>';
  const project = '<div class="container" id="projContainer"> <h1 id="projHeading"><strong>Recent Projects</strong></h1> <div class="d-flex align-items-center" id="projDiv"> <div class="card" id="projCard"> <div class="card-body" id="mlType"> <h6 class="text-muted card-subtitle mb-2" style="font-size: 12px;">Upcoming in 2022 Q2</h6> <h4 class="card-title">CoreML Collection</h4> <h6 class="text-muted card-subtitle mb-2" style="font-size: 12px;">Pre-trained models for Apple Devices - Machine Learning</h6> <p class="card-text" id="cardPara"><span id="firstChar">A</span>user-friendly application that suggests to parents their baby name.</p> <div class="form-check d-xxl-flex align-items-xxl-start" style="font-size: 12px;"><input class="form-check-input" type="checkbox" id="formCheck-5" style="margin-right: 5px;" checked="" disabled><label class="form-check-label" for="formCheck-5">Free Usage</label></div> <div class="form-check d-xxl-flex align-items-xxl-start" style="margin-bottom: 5px;font-size: 12px;"><input class="form-check-input" type="checkbox" id="formCheck-6" style="margin-right: 5px;" checked="" disabled><label class="form-check-label" for="formCheck-6">Open Source</label></div><a class="card-link" href="#" target="_blank">Preview&nbsp;<i class="fas fa-external-link-alt"></i></a><a class="card-link" href="#">Github&nbsp;<i class="fab fa-github"></i></a> </div> </div> <div class="card" id="projCard"> <div class="card-body"> <h6 class="text-muted card-subtitle mb-2" style="font-size: 12px;">Published in 2022 Q1</h6> <h4 class="card-title">Return YouTube Dislike</h4> <h6 class="text-muted card-subtitle mb-2" style="font-size: 12px;">A Quality Rating before watch - Web Extension for Safari</h6> <p class="card-text" id="cardPara"><span id="firstChar">W</span>aste less time on the content farm and untrustful content.<br /></p> <div class="form-check d-xxl-flex align-items-xxl-start" style="font-size: 12px;"><input class="form-check-input" type="checkbox" id="formCheck-9" style="margin-right: 5px;" checked="" disabled><label class="form-check-label" for="formCheck-9">Free Usage</label></div> <div class="form-check d-xxl-flex align-items-xxl-start" style="margin-bottom: 5px;font-size: 12px;"><input class="form-check-input" type="checkbox" id="formCheck-10" style="margin-right: 5px;" checked="" disabled><label class="form-check-label" for="formCheck-10">Open Source</label></div><a class="card-link" href="/api/dlRYDmac">For Mac Universal&nbsp;<i class="fas fa-cloud-download-alt"></i></a><a class="card-link" href="https://github.com/1998code/return-youtube-dislike/tree/main/Extensions/SafariApp" target="_blank">Github&nbsp;<i class="fab fa-github"></i></a> </div> </div> <div class="card" id="projCard"> <div class="card-body" id="mlType"> <h6 class="text-muted card-subtitle mb-2" style="font-size: 12px;">Published in 2022 Q1</h6> <h4 class="card-title">Baby Name Generator</h4> <h6 class="text-muted card-subtitle mb-2" style="font-size: 12px;">Natural Language Processing - Deep Machine Learning</h6> <p class="card-text" id="cardPara"><span id="firstChar">A</span>user-friendly application that suggests to parents their baby name.</p> <div class="form-check d-xxl-flex align-items-xxl-start" style="font-size: 12px;"><input class="form-check-input" type="checkbox" id="formCheck-1" style="margin-right: 5px;" checked="" disabled><label class="form-check-label" for="formCheck-1">Free Usage</label></div> <div class="form-check d-xxl-flex align-items-xxl-start" style="margin-bottom: 5px;font-size: 12px;"><input class="form-check-input" type="checkbox" id="formCheck-2" style="margin-right: 5px;" checked="" disabled><label class="form-check-label" for="formCheck-2">Open Source</label></div><a class="card-link" href="https://bng.1998.media" target="_blank">Preview&nbsp;<i class="fas fa-external-link-alt"></i></a><a class="card-link" href="#">Github&nbsp;<i class="fab fa-github"></i></a> </div> </div> <div class="card" id="projCard"> <div class="card-body"> <h6 class="text-muted card-subtitle mb-2" style="font-size: 12px;">Published in 2020 Q2</h6> <h4 class="card-title">Bootstrap Themes</h4> <h6 class="text-muted card-subtitle mb-2" style="font-size: 12px;">Pre-made framework templates for developers training</h6> <p class="card-text" id="cardPara"><span id="firstChar">V</span>arious modern web templates are ready to use for training purposes.<br /></p> <div class="form-check d-xxl-flex align-items-xxl-start" style="font-size: 12px;"><input class="form-check-input" type="checkbox" id="formCheck-3" style="margin-right: 5px;" checked="" disabled><label class="form-check-label" for="formCheck-3">Free Usage</label></div> <div class="form-check d-xxl-flex align-items-xxl-start" style="margin-bottom: 5px;font-size: 12px;"><input class="form-check-input" type="checkbox" id="formCheck-4" style="margin-right: 5px;" checked="" disabled><label class="form-check-label" for="formCheck-4">Open Source</label></div><a class="card-link" href="#">Preview&nbsp;<i class="fas fa-external-link-alt"></i></a><a class="card-link" href="#">Github&nbsp;<i class="fab fa-github"></i></a> </div> </div> </div> </div>'
  const faq = ' <div class="container" id="faqContainer"> <h1 id="faqHeading"><strong>Question and Answering</strong></h1> <div class="accordion" role="tablist" id="accordion-qa"> <div class="accordion-item"> <h2 class="accordion-header" role="tab"><button class="accordion-button" data-bs-toggle="collapse" data-bs-target="#accordion-qa .item-1" aria-expanded="true" aria-controls="accordion-qa .item-1">[Support]&nbsp;How to support your open source projects?</button></h2> <div class="accordion-collapse collapse show item-1" role="tabpanel" data-bs-parent="#accordion-qa"> <div class="accordion-body"> <p class="text-truncate mb-0"><i class="fab fa-github"></i>&nbsp;Github for sponsor:&nbsp;<a href="https://github.com/sponsors/1998code" target="_blank"><span style="text-decoration: underline;">https://github.com/sponsors/1998code</span></a><br /><br /><i class="fab fa-google"></i>&nbsp;Google Ads:<br /><br /><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script> <!-- M-ADS Q1 --> <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-1941913120815371" data-ad-slot="1600474556" data-ad-format="auto" data-full-width-responsive="true"></ins> <script> (adsbygoogle = window.adsbygoogle || []).push({}); </script></p> </div> </div> </div> <div class="accordion-item"> <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-qa .item-2" aria-expanded="false" aria-controls="accordion-qa .item-2">[OSS] Where do your Open Source works hosts?</button></h2> <div class="accordion-collapse collapse item-2" role="tabpanel" data-bs-parent="#accordion-qa"> <div class="accordion-body"> <p class="mb-0">Github: <a href="https://github.com/1998code">https://github.com/1998code&nbsp;</a><i class="fas fa-external-link-alt" style="color: rgb(19,112,253);"></i><br />Vercel:&nbsp;<a href="https://vercel.com/?utm_source=1998code&amp;utm_campaign=oss">https://vercel.com</a>&nbsp;<i class="fas fa-external-link-alt" style="color: rgb(19,112,253);"></i></p> </div> </div> </div> <div class="accordion-item"> <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-qa .item-3" aria-expanded="false" aria-controls="accordion-qa .item-3">[Job] How to contact you?</button></h2> <div class="accordion-collapse collapse item-3" role="tabpanel" data-bs-parent="#accordion-qa"> <div class="accordion-body"> <p class="mb-0">Please contact by email: <a href="mailto:job@1998.media">job@1998.media</a></p> </div> </div> </div> <div class="accordion-item"> <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-qa .item-4" aria-expanded="false" aria-controls="accordion-qa .item-4" style="border-style: none;border-bottom-right-radius: 15px;border-bottom-left-radius: 15px;">[ML] Wanna chat with my bot and learn more?</button></h2> <div class="accordion-collapse collapse item-4" role="tabpanel" data-bs-parent="#accordion-qa"> <div class="accordion-body"> <p class="mb-0">Visit my Google Dialogflow Project:&nbsp;<a href="https://console.dialogflow.com/api-client/demo/embedded/7588efa8-1c68-497c-819e-3d1dfef8f164" target="_blank">https://console.dialogflow.com/api-client/demo/embedded/7588efa8-1c68-497c-819e-3d1dfef8f164</a></p> </div> </div> </div> </div> </div>'
  ...
  return (
    <div>
      ...
      <body onload="choosePic()">
        ...
        <section data-aos="fade" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true" id="contact">
        ...
        <footer data-aos="fade" data-aos-once="true" class="footer-basic">
          ...
          <p class="copyright">
            Made with&nbsp;♥&nbsp;by MING.
            <br />
            <small>Ver. 22.3.7 | Since 2020</small>
          </p>
