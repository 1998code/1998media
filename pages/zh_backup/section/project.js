    ...
    <div id="project" data-aos="zoom-in" data-aos-once className="relative pt-16 md:py-20 px-4 sm:px-6 lg:px-8">
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="mt-8 mx-auto grid gap-5 md:grid-cols-4 lg:max-w-none">
          <img loading="lazy" className="w-full col-span-3 hover:scale-105 transition duration-300" src="https://gitstats.1998.media/api?username=1998code&show_icons=true&bg_color=30,e96443,904e95&title_color=fff&text_color=fff&icon_color=fff&hide_border=true" alt="Performance" />
          <img loading="lazy" className="w-full col-span-3 md:col-span-1 dark:hidden hover:scale-105 transition duration-300" src="https://gitstats.1998.media/api/top-langs/?username=1998code&langs_count=8&layout=default&hide_border=true" alt="Top Languages" />
          <img loading="lazy" className="w-full col-span-3 md:col-span-1 hidden dark:block hover:scale-105 transition duration-300" src="https://gitstats.1998.media/api/top-langs/?username=1998code&langs_count=8&layout=default&bg_color=000&title_color=fff&text_color=fff&hide_border=true" alt="Top Languages" />
        </div>
        <img loading="lazy" id="projectChart" className="w-full p-3 hover:scale-105 transition duration-300" src="https://ghchart.rshah.org/1998code" alt="Github chart" />
