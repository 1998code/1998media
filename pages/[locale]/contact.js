          ...
          <div className="relative bg-orange-600 md:col-start-3 md:row-start-1 md:col-span-10 md:rounded-3xl md:grid md:grid-cols-10 md:items-center">
            ...
            <div className="relative mx-auto py-12 px-4 space-y-6 sm:py-16 sm:px-6 md:p-0 md:col-start-4 md:col-span-6">
              ...
              <p className="text-lg text-white">
                {i18n(
                  'Response in 48 hours. Holidays may take longer. No spam, please.'
                )}
              </p>
              <a
      ...
      {typeof window !== 'undefined' &&
        document.location.href.includes('zh-CN') && (
          <a
            ...
            target="_blank"
            className="relative block w-full mt-6 text-center md:text-right max-w-7xl mx-auto sm:px-6 md:px-8"
          >
            <img
              alt="Xiaohongshu Profile"
              loading="lazy"
              className="rounded-3xl max-w-[500px]"
              src="https://cdn.1998.media/banners/Xiaohongshu.jpg"
            />
          </a>
        )}
    </div>
