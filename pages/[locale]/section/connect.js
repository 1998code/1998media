export default function Connect(props) {
  ...
  return (
    <div id="connect" data-aos="zoom-in" data-aos-once className="hidden dark:block relative pt-16 md:py-20 px-4 sm:px-6 lg:px-8">
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="mt-8 bg-black rounded-lg overflow-hidden">
          <iframe width="100%" height="60" src="https://rss.app/embed/v1/ticker/uinAtIEboH5CBIfo" frameborder="0"></iframe>
          <iframe width="100%" height="450"  src="https://rss.app/embed/v1/carousel/uinAtIEboH5CBIfo" frameborder="0"></iframe>
        </div>
      </div>
    </div>
  )
