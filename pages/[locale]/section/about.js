    ...
    <div id="about" className="max-w-7xl mx-auto py-16 md:mb-20 px-4 sm:px-6 lg:px-8 bg-orange-200 dark:bg-orange-800 bg-opacity-50 xl:rounded-3xl">
      <div className="lg:grid lg:grid-cols-2 lg:gap-8">
        <h2 className="max-w-md mx-auto text-3xl font-extrabold text-orange-900 dark:text-orange-100 text-center lg:max-w-xl lg:text-left">
          <img src="https://cdn.1998.media/favicon23.jpg" className="rounded-full w-24 h-24" loading="lazy" />
          <br /><br />
        ...
        <div className="flow-root self-center">
          <div className="-ml-8 flex flex-wrap lg:-ml-4">
            <div className="mt-4 ml-8 flex flex-grow flex-shrink-0 justify-center lg:flex-grow-0 lg:ml-4">
              <img className="h-24 dark:hidden" src="https://cdn.1998.media/logos/CityU.png" alt="CityU" loading="lazy" />
              <img className="h-24 hidden dark:block" src="https://cdn.1998.media/logos/CityU_dark.png" alt="CityU" loading="lazy" />
            </div>
            <div className="mt-4 ml-8 flex flex-grow flex-shrink-0 justify-center lg:flex-grow-0 lg:ml-4">
              <img className="h-24 dark:hidden" src="https://cdn.1998.media/logos/PolyU.webp" alt="PolyU" />
              <img className="h-24 hidden dark:block" src="https://cdn.1998.media/logos/PolyU_dark.webp" alt="PolyU" loading="lazy" />
            </div>
            <div className="mt-4 ml-8 flex flex-grow flex-shrink-0 justify-center lg:flex-grow-0 lg:ml-4">
              <img className="h-24 dark:hidden" src="https://cdn.1998.media/logos/Google.png" alt="Google" />
              <img className="h-24 hidden dark:block" src="https://cdn.1998.media/logos/Google_dark.png" alt="Google" loading="lazy" />
            </div>
            <img src="https://cdn.1998.media/bgs/Calculator.png" loading="lazy" />
          </div>
        </div>
      </div>
