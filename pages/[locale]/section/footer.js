...
export default function Footer(props) {
  function i18n(key) {
      return props.i18n && props.i18n['footer'] ? props.i18n['footer'][key] : key
  }
    ...
    <div data-aos="zoom-in" data-aos-once className="right-0 max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-gray-400 text-sm">{i18n("Ver.")} 23.03.04 | {i18n("Since")} 2020 | {i18n("Open Source")}{i18n(".")}</p>
        </div>
