...
export default function Home() {
  ...
  const sections = ['header', 'about', 'achievements', 'impacts', 'skills', 'experience', 'projects', 'blog', 'connect', 'ai', 'openAPI', 'faq', 'contact']
          ...
          {loading ?
            <Loading /> : (
              <div>
                ...
                />
                <div className="elfsight-app-d9c75342-d244-4ae0-91fd-78feae7b7d90" data-elfsight-app-lazy></div>
              </div>
            )}
        </RoomProvider>
      </main>
