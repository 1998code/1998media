  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-black p-8">
      <div className="max-w-md w-full bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8 flex flex-col gap-6">
        <div>
          <h1 className="text-2xl font-bold dark:text-white">Apple Music Setup</h1>
        ...
        {status === 'authorized' ? (
          <div className="flex flex-col gap-3">
            <p className="text-sm font-medium text-green-600">Authorization successful!</p>
            <p className="text-xs text-gray-500">
              Copy the token below and set it as <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">APPLE_MUSIC_USER_TOKEN</code> in your environment.
            </p>
