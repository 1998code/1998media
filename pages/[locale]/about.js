export default function About(props) {
  ...
  return (
    <div
      id="about"
      className="max-w-7xl mx-auto py-16 md:mb-20 px-4 sm:px-6 lg:px-8 bg-orange-200 dark:bg-orange-800 bg-opacity-50 xl:rounded-xl"
    >
      <div className="lg:grid lg:grid-cols-2 lg:gap-8">
        <h2 className="max-w-md mx-auto text-3xl font-extrabold text-orange-900 dark:text-orange-100 text-center lg:max-w-xl lg:text-left">
          ...
          <span className="text-orange-500 dark:text-orange-400">
            <i className="far fa-computer-classic"></i>{' '}
            {i18n('Software Engineer')}
          </span>{' '}
          {i18n('working on')}{' '}
          <span className="text-orange-700 dark:text-orange-300">
            <i className="far fa-sidebar"></i> {i18n('UI Design,')}{' '}
            <i className="far fa-command"></i> {i18n('App Development,')}{' '}
            <i className="far fa-brain-circuit"></i> {i18n('Neural Network,')}{' '}
            {i18n('and')} <i className="far fa-server"></i>{' '}
            {i18n('Deep Machine Learning Research.')}
          </span>
          <br />
          <br />
          ...
          {i18n('studying within a great IT environment.')}{' '}
          <span className="text-yellow-600 dark:text-yellow-400">
            {i18n(
              'Eager to work in a large and professional MNC in Design and Programming related industry'
            )}{' '}
            <i className="far fa-briefcase"></i> {i18n('in the future.')}
          </span>
        </h2>
